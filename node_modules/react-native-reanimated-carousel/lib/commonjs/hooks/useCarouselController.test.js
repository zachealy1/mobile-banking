...
const mockGlobalState = {
  props: {
    ...
    width: 300,
    height: 300,
    renderItem: () => /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: {
        flex: 1
      }
    }),
...
const wrapper = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_store.GlobalStateContext.Provider, {
...
describe("useCarouselController", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    mockHandlerOffset = (0, _reactNativeReanimated.useSharedValue)(0);
  ...
  it("should initialize with default index", () => {
    ...
    const {
      result
    } = (0, _reactHooks.renderHook)(() => (0, _useCarouselController.useCarouselController)({ ...defaultProps,
      defaultIndex: 2
    }), {
      wrapper
    });
...
describe("useCarouselController imperative handle", () => {
  ...
  it("should maintain correct index through imperative calls", () => {
    ...
    const createHandle = _react.useImperativeHandle.mock.calls[0][1];
