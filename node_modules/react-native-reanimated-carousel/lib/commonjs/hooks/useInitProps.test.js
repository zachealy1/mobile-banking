...
var _useInitProps = require("./useInitProps");
...
describe("useInitProps", () => {
  ...
  const defaultProps = {
    ...
    renderItem: _ref => {
      ...
      return /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, "Item");
    }
  };
  it("should initialize with default values", () => {
    const {
      result
    } = (0, _reactHooks.renderHook)(() => (0, _useInitProps.useInitProps)(defaultProps));
  ...
  it("should handle custom values", () => {
    ...
    const {
      result
    } = (0, _reactHooks.renderHook)(() => (0, _useInitProps.useInitProps)(customProps));
  ...
  it("should handle stack mode configuration", () => {
    ...
    const {
      result
    } = (0, _reactHooks.renderHook)(() => (0, _useInitProps.useInitProps)(stackProps));
  ...
  it("should handle empty data array", () => {
    ...
    const {
      result
    } = (0, _reactHooks.renderHook)(() => (0, _useInitProps.useInitProps)(props));
